<div class="container">
    <div class="page-head"><div><div class="eyebrow">Facturacion</div><h1>Facturas Emitidas</h1></div></div>
            ...
            <tbody>
                <?php foreach ($facturas as $f): ?>
                    <tr>
                        ...
                        <td><a class="btn btn-outline btn-sm" href="/facturas/ver?id=<?= (int) $f['id'] ?>">Ver</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
