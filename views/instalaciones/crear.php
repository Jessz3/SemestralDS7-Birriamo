        ...
        <form method="POST" action="/instalaciones/crear">
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input type="number" name="capacidad_invitados" value="<?= htmlspecialchars($datos['capacidad_invitados'] ?? 0) ?>" min="0" required>
                </div>
                <div class="field">
                    <label>Costo base ($)</label>
                    <input type="number" step="0.01" name="costo_base" value="<?= htmlspecialchars($datos['costo_base'] ?? 0) ?>" min="0" required>
                </div>
            </div>
