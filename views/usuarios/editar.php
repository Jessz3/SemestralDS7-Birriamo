    ...
    <div class="card">
        <form method="POST" action="/usuarios/editar">
            ...
            <div class="grid-2">
                <div class="field">
                    <label>Nombre</label>
                    <input type="text" name="nombre" value="<?= htmlspecialchars($usuario['nombre']) ?>" minlength="2" maxlength="80" required>
                </div>
                <div class="field">
                    <label>Apellido</label>
                    <input type="text" name="apellido" value="<?= htmlspecialchars($usuario['apellido']) ?>" minlength="2" maxlength="80" required>
                </div>
            </div>
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input type="text" name="usuario" value="<?= htmlspecialchars($usuario['usuario']) ?>" pattern="[A-Za-z0-9]+" minlength="3" maxlength="60" title="Use solamente letras y numeros" required>
                </div>
                <div class="field">
                    <label>Rol</label>
            ...
            <div class="field">
                ...
                <input type="email" name="correo" value="<?= htmlspecialchars($usuario['correo']) ?>" maxlength="150" required>
            </div>
