        ...
        <form method="POST" action="/actividades/editar">
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input type="number" name="edad_minima" min="0" value="<?= htmlspecialchars($actividad['edad_minima'] ?? '') ?>">
                </div>
                <div class="field">
                    <label>Edad maxima (opcional)</label>
                    <input type="number" name="edad_maxima" min="0" value="<?= htmlspecialchars($actividad['edad_maxima'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input type="number" name="cupos_disponibles" value="<?= (int) $actividad['cupos_disponibles'] ?>" min="1" required>
                </div>
                <div class="field">
                    <label>Capacidad de invitados</label>
                    <input type="number" name="capacidad_invitados" value="<?= (int) $actividad['capacidad_invitados'] ?>" min="0">
                </div>
            </div>
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input type="number" step="0.01" name="costo_inscripcion" value="<?= htmlspecialchars($actividad['costo_inscripcion']) ?>" min="0" required>
                </div>
                <div class="field">
                    <label>Costo de instalacion ($, uso interno)</label>
                    <input type="number" step="0.01" name="costo_instalacion" value="<?= htmlspecialchars($actividad['costo_instalacion']) ?>" min="0">
                </div>
            </div>

            <div class="field">
                <label>Descripcion</label>
                <textarea name="descripcion" rows="3" required><?= htmlspecialchars($actividad['descripcion']) ?></textarea>
            </div>
            <div class="field">
