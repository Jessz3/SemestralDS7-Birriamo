...
-- Tiempo de generación: 14-07-2026 a las 16:27:12
...
CREATE TABLE IF NOT EXISTS `academias` (
  ...
  `ruc` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_academias_nombre` (`nombre`),
  UNIQUE KEY `uq_academias_ruc` (`ruc`)
...
(1, 'Halcones', '123', '', 'halcones@gmail.com', '323232', 'Don bosco', NULL, 1, '2026-07-13 16:10:51', '2026-07-13 17:46:07');
...
DROP TABLE IF EXISTS `academia_deportes`;
CREATE TABLE IF NOT EXISTS `academia_deportes` (
  `academia_id` int UNSIGNED NOT NULL,
  `deporte_id` int UNSIGNED NOT NULL,
  PRIMARY KEY (`academia_id`,`deporte_id`),
  KEY `fk_academia_deportes_deporte` (`deporte_id`)
...
CREATE TABLE IF NOT EXISTS `actividades` (
  ...
  `entrenador_id` int UNSIGNED DEFAULT NULL,
  `tipo` enum('BIRRIA','ENTRENAMIENTO','TORNEO','EVENTO') COLLATE utf8mb4_unicode_ci NOT NULL,
  `modalidad` enum('INDIVIDUAL','EQUIPO','MIXTA') COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `edad_minima` smallint UNSIGNED DEFAULT NULL,
  `edad_maxima` smallint UNSIGNED DEFAULT NULL,
  `cupos_disponibles` int UNSIGNED NOT NULL DEFAULT '0',
  `capacidad_invitados` int UNSIGNED NOT NULL DEFAULT '0',
  ...
  `token_publico` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `estado` enum('BORRADOR','PUBLICADA','CERRADA','FINALIZADA','CANCELADA','TRASLADADA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BORRADOR',
  `motivo_cancelacion` text COLLATE utf8mb4_unicode_ci,
  `actividad_origen_id` int UNSIGNED DEFAULT NULL,
  `fecha_publicacion` datetime DEFAULT NULL,
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_actualizacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_actividades_token` (`token_publico`),
  KEY `fk_actividades_instalacion` (`instalacion_id`),
  KEY `fk_actividades_entrenador` (`entrenador_id`),
  KEY `fk_actividades_origen` (`actividad_origen_id`),
  KEY `idx_actividades_estado_fecha` (`estado`,`fecha_inicio`),
  KEY `idx_actividades_organizador` (`organizador_id`),
  KEY `idx_actividades_deporte` (`deporte_id`)
...
(1, 2, 5, 1, NULL, 'TORNEO', 'EQUIPO', 'Partido del mundial', 'Partido entre china vs panama', '', '2026-07-06 16:15:00', '2026-07-13 16:20:00', '2026-07-31 16:15:00', 10, NULL, 20, 0, 1, 3.00, 3.00, NULL, '/evento/1d63a1a44483e605c53605f81b8c82a659239bc6591f43041729e80612647662', '1d63a1a44483e605c53605f81b8c82a659239bc6591f43041729e80612647662', 'FINALIZADA', NULL, NULL, '2026-07-13 16:17:43', '2026-07-13 16:16:35', '2026-07-13 17:38:03'),
...
DROP TABLE IF EXISTS `actividad_arbitros`;
CREATE TABLE IF NOT EXISTS `actividad_arbitros` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `actividad_id` int UNSIGNED NOT NULL,
  `arbitro_id` int UNSIGNED NOT NULL,
  `rol` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Árbitro principal',
  `estado` enum('ASIGNADO','CONFIRMADO','RECHAZADO','FINALIZADO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ASIGNADO',
  `fecha_asignacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_actividad_arbitro` (`actividad_id`,`arbitro_id`),
  KEY `fk_actividad_arbitros_arbitro` (`arbitro_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `arbitros` (
  ...
  `correo` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `licencia` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `experiencia` text COLLATE utf8mb4_unicode_ci,
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_arbitros_cedula` (`cedula`),
  UNIQUE KEY `uq_arbitros_licencia` (`licencia`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `arbitro_deportes`;
CREATE TABLE IF NOT EXISTS `arbitro_deportes` (
  `arbitro_id` int UNSIGNED NOT NULL,
  `deporte_id` int UNSIGNED NOT NULL,
  PRIMARY KEY (`arbitro_id`,`deporte_id`),
  KEY `fk_arbitro_deportes_deporte` (`deporte_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `bitacora` (
  ...
  `tabla_afectada` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `registro_id` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  ...
  `algoritmo_firma` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_evento` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_bitacora_usuario_fecha` (`usuario_id`,`fecha_evento`)
) ;
...
(36, 5, 'AUTENTICACION', 'LOGIN', 'usuarios', '5', 'Inicio de sesion exitoso.', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '51a18ab8e424dcaec56b2a28840740f418c087df4ec161ac50fb93dcbb0ae088', 'HMAC-SHA256', '2026-07-13 17:24:48'),
(37, 5, 'ACTIVIDADES', 'FINALIZAR', 'actividades', '1', 'Actividad finalizada.', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '94c95439f8bbdf7f2be9a39303269963fa546489206370728dfa076d40decad9', 'HMAC-SHA256', '2026-07-13 17:38:03'),
(38, 1, 'AUTENTICACION', 'LOGIN', 'usuarios', '1', 'Inicio de sesion exitoso.', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'cfad07e35f870b85fd05ed00af9e94474fb0cc1dfe86723ed5d3a8d7f8f0cf8a', 'HMAC-SHA256', '2026-07-13 17:42:38'),
(39, 1, 'ACTIVIDADES', 'CREAR', 'actividades', '4', 'Actividad \'dafjh\' creada en estado BORRADOR.', NULL, '{\"organizador_id\":3,\"deporte_id\":5,\"instalacion_id\":1,\"entrenador_id\":null,\"tipo\":\"TORNEO\",\"modalidad\":\"EQUIPO\",\"nombre\":\"dafjh\",\"descripcion\":\"hola\",\"reglas\":\"\",\"fecha_inicio\":\"2000-12-12 12:12\",\"fecha_fin\":\"2001-10-11 01:11\",\"fecha_cierre_inscripcion\":null,\"edad_minima\":null,\"edad_maxima\":null,\"cupos_disponibles\":20,\"capacidad_invitados\":0,\"requiere_pago\":1,\"costo_inscripcion\":0,\"costo_instalacion\":0,\"arbitros\":[]}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '1b259bf84aef98f51212c3625d467fbd3dad9280a758ad97b5cbd08ce5dd613a', 'HMAC-SHA256', '2026-07-13 17:43:56'),
(40, 5, 'AUTENTICACION', 'LOGIN', 'usuarios', '5', 'Inicio de sesion exitoso.', NULL, NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '51a18ab8e424dcaec56b2a28840740f418c087df4ec161ac50fb93dcbb0ae088', 'HMAC-SHA256', '2026-07-13 17:44:25');
...
DROP TABLE IF EXISTS `calendario_actividad_fechas`;
CREATE TABLE IF NOT EXISTS `calendario_actividad_fechas` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `actividad_id` int UNSIGNED NOT NULL,
  `titulo` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fecha_inicio` datetime NOT NULL,
  `fecha_fin` datetime NOT NULL,
  `instalacion_id` int UNSIGNED DEFAULT NULL,
  `descripcion` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_jornada` smallint UNSIGNED DEFAULT NULL,
  `estado` enum('PROGRAMADA','REALIZADA','CANCELADA','TRASLADADA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PROGRAMADA',
  PRIMARY KEY (`id`),
  KEY `fk_calendario_actividad` (`actividad_id`),
  KEY `fk_calendario_instalacion` (`instalacion_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `claves_rsa_usuario`;
CREATE TABLE IF NOT EXISTS `claves_rsa_usuario` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `usuario_id` int UNSIGNED NOT NULL,
  `clave_publica` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `clave_privada_cifrada` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `algoritmo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RSA-2048',
  `huella_publica` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `activa` tinyint(1) NOT NULL DEFAULT '1',
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_revocacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_claves_rsa_huella` (`huella_publica`),
  KEY `fk_claves_rsa_usuario` (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `deportes` (
  ...
  `minimo_jugadores` smallint UNSIGNED DEFAULT NULL,
  `maximo_jugadores` smallint UNSIGNED DEFAULT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_actualizacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `devoluciones` (
  ...
  `estado` enum('SOLICITADA','APROBADA','PROCESADA','RECHAZADA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SOLICITADA',
  `referencia_devolucion` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `solicitada_por` int UNSIGNED DEFAULT NULL,
  `procesada_por` int UNSIGNED DEFAULT NULL,
  `fecha_solicitud` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_proceso` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_devoluciones_pago` (`pago_id`),
  KEY `fk_devoluciones_factura` (`factura_id`),
  KEY `fk_devoluciones_actividad` (`actividad_id`),
  KEY `fk_devoluciones_solicitada_por` (`solicitada_por`),
  KEY `fk_devoluciones_procesada_por` (`procesada_por`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `entrenadores` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `organizador_id` int UNSIGNED DEFAULT NULL,
  ...
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_entrenadores_cedula` (`cedula`),
  KEY `fk_entrenadores_organizador` (`organizador_id`),
  KEY `fk_entrenadores_academia` (`academia_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `entrenador_deportes`;
CREATE TABLE IF NOT EXISTS `entrenador_deportes` (
  `entrenador_id` int UNSIGNED NOT NULL,
  `deporte_id` int UNSIGNED NOT NULL,
  PRIMARY KEY (`entrenador_id`,`deporte_id`),
  KEY `fk_entrenador_deportes_deporte` (`deporte_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `equipos` (
  ...
  `fecha_actualizacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_equipos_academia` (`academia_id`),
  KEY `fk_equipos_deporte` (`deporte_id`),
  KEY `idx_equipos_participante` (`participante_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `evaluaciones_arbitros`;
CREATE TABLE IF NOT EXISTS `evaluaciones_arbitros` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `actividad_id` int UNSIGNED NOT NULL,
  `arbitro_id` int UNSIGNED NOT NULL,
  `organizador_id` int UNSIGNED NOT NULL,
  `puntuacion` tinyint UNSIGNED NOT NULL,
  `puntualidad` tinyint UNSIGNED DEFAULT NULL,
  `conocimiento_reglas` tinyint UNSIGNED DEFAULT NULL,
  `imparcialidad` tinyint UNSIGNED DEFAULT NULL,
  `manejo_actividad` tinyint UNSIGNED DEFAULT NULL,
  `comentario` text COLLATE utf8mb4_unicode_ci,
  `fecha_evaluacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_evaluacion_arbitro` (`actividad_id`,`arbitro_id`,`organizador_id`),
  KEY `fk_evaluaciones_organizador` (`organizador_id`),
  KEY `idx_evaluaciones_arbitro` (`arbitro_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `facturas` (
  ...
  `identificacion_cliente` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `correo_cliente` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pdf_hash_sha256` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `firma_digital` longtext COLLATE utf8mb4_unicode_ci,
  `certificado_publico` mediumtext COLLATE utf8mb4_unicode_ci,
  `algoritmo_firma` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'SHA256withRSA',
  `formato_documento` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PDF/A',
  `fecha_firma` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_facturas_numero` (`numero_factura`),
  UNIQUE KEY `uq_facturas_pago` (`pago_id`),
  KEY `fk_facturas_participante` (`participante_id`),
  KEY `fk_facturas_actividad` (`actividad_id`),
  KEY `fk_facturas_equipo` (`equipo_id`),
  KEY `idx_facturas_fecha` (`fecha_venta`)
...
CREATE TABLE IF NOT EXISTS `historial_passwords` (
  ...
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_historial_password_usuario` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `incidentes_deportivos`;
CREATE TABLE IF NOT EXISTS `incidentes_deportivos` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `actividad_id` int UNSIGNED NOT NULL,
  ...
  `tipo` enum('LESION','CONDUCTA_ANTIDEPORTIVA','EXPULSION','DAÑO_INSTALACION','SUSPENSION','OTRO') COLLATE utf8mb4_unicode_ci NOT NULL,
  `gravedad` enum('LEVE','MODERADA','GRAVE','CRITICA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'LEVE',
  `descripcion` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `acciones_tomadas` text COLLATE utf8mb4_unicode_ci,
  `fecha_incidente` datetime NOT NULL,
  `estado` enum('ABIERTO','EN_REVISION','RESUELTO','CERRADO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ABIERTO',
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_incidentes_reportado_por` (`reportado_por`),
  KEY `fk_incidentes_arbitro` (`arbitro_id`),
  KEY `fk_incidentes_equipo` (`equipo_id`),
  KEY `fk_incidentes_jugador` (`jugador_id`),
  KEY `idx_incidentes_actividad` (`actividad_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `incidentes_deportivos`
--

INSERT INTO `incidentes_deportivos` (`id`, `actividad_id`, `reportado_por`, `arbitro_id`, `equipo_id`, `jugador_id`, `tipo`, `gravedad`, `descripcion`, `acciones_tomadas`, `fecha_incidente`, `estado`, `fecha_creacion`) VALUES
(2, 1, 5, NULL, NULL, NULL, 'DAÑO_INSTALACION', 'LEVE', 'alguien rompió una tubería ayer', NULL, '2015-12-12 12:12:00', 'ABIERTO', '2026-07-13 17:45:46');
...
DROP TABLE IF EXISTS `inscripciones_equipos`;
CREATE TABLE IF NOT EXISTS `inscripciones_equipos` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `actividad_id` int UNSIGNED NOT NULL,
  `equipo_id` int UNSIGNED NOT NULL,
  `estado` enum('PENDIENTE_PAGO','PAGO_PENDIENTE_VALIDACION','PENDIENTE_APROBACION','APROBADA','RECHAZADA','CANCELADA','FINALIZADA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDIENTE_PAGO',
  `observaciones` text COLLATE utf8mb4_unicode_ci,
  `reglas_facilitadas` text COLLATE utf8mb4_unicode_ci,
  `reglas_aceptadas` tinyint(1) NOT NULL DEFAULT '0',
  `fecha_inscripcion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_aprobacion` datetime DEFAULT NULL,
  `aprobado_por` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inscripcion_equipo` (`actividad_id`,`equipo_id`),
  KEY `fk_inscripcion_equipo_equipo` (`equipo_id`),
  KEY `fk_inscripcion_equipo_aprobado` (`aprobado_por`),
  KEY `idx_inscripciones_equipo_estado` (`estado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `inscripciones_individuales`;
CREATE TABLE IF NOT EXISTS `inscripciones_individuales` (
  ...
  `aprobado_por` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inscripcion_individual` (`actividad_id`,`participante_id`),
  KEY `fk_inscripcion_ind_participante` (`participante_id`),
  KEY `fk_inscripcion_ind_aprobado` (`aprobado_por`),
  KEY `idx_inscripciones_ind_estado` (`estado`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `instalaciones` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` enum('CANCHA','GIMNASIO','PISCINA','ESTADIO','PISTA','SALON','OTRO') COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_unicode_ci,
  `direccion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provincia` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Panamá',
  ...
  `espacio_disponible` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `capacidad_invitados` int UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `invitaciones` (
  ...
  `estado` enum('PENDIENTE','ACEPTADA','RECHAZADA','VENCIDA') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDIENTE',
  `fecha_envio` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_respuesta` datetime DEFAULT NULL,
  `fecha_expiracion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_invitaciones_token` (`token`),
  KEY `fk_invitaciones_actividad` (`actividad_id`),
  KEY `fk_invitaciones_academia` (`academia_id`),
  KEY `fk_invitaciones_equipo` (`equipo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `jugadores` (
  ...
  `posicion` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_camiseta` smallint UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mensajes_contacto` (
  ...
  `estado` enum('NUEVO','LEIDO','RESPONDIDO','CERRADO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NUEVO',
  `fecha_envio` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atendido_por` int UNSIGNED DEFAULT NULL,
  `fecha_atencion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_mensajes_atendido_por` (`atendido_por`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `organizadores` (
  ...
  `usuario_id` int UNSIGNED NOT NULL,
  `academia_id` int UNSIGNED DEFAULT NULL,
  `tipo_organizador` enum('INDEPENDIENTE','ACADEMIA','ENTRENADOR','EMPRESA','COMITE','OTRO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'INDEPENDIENTE',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_organizadores_usuario` (`usuario_id`),
  KEY `fk_organizadores_academia` (`academia_id`),
  KEY `fk_organizadores_verificado_por` (`verificado_por`)
...
(1, 2, NULL, 'ENTRENADOR', '', '', 1, '2026-07-13 17:42:48', 1, 1, '2026-07-13 15:49:45'),
(2, 3, NULL, 'INDEPENDIENTE', NULL, NULL, 1, '2026-07-13 17:42:42', 1, 1, '2026-07-13 15:52:02'),
(3, 5, NULL, 'INDEPENDIENTE', NULL, NULL, 0, NULL, NULL, 0, '2026-07-13 16:02:37');
...
CREATE TABLE IF NOT EXISTS `pagos` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `inscripcion_individual_id` bigint UNSIGNED DEFAULT NULL,
  `inscripcion_equipo_id` bigint UNSIGNED DEFAULT NULL,
  `participante_id` int UNSIGNED NOT NULL,
  `metodo_pago` enum('EFECTIVO','TRANSFERENCIA','TARJETA','YAPPY','OTRO') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `estado` enum('PENDIENTE','EN_REVISION','APROBADO','RECHAZADO','DEVUELTO','ANULADO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDIENTE',
  `fecha_pago` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fecha_validacion` datetime DEFAULT NULL,
  `validado_por` int UNSIGNED DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `fk_pagos_inscripcion_individual` (`inscripcion_individual_id`),
  KEY `fk_pagos_inscripcion_equipo` (`inscripcion_equipo_id`),
  KEY `fk_pagos_participante` (`participante_id`),
  KEY `fk_pagos_validado_por` (`validado_por`),
...
CREATE TABLE IF NOT EXISTS `participantes` (
  ...
  `observaciones_medicas` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  `fecha_registro` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_participantes_usuario` (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tokens_recuperacion` (
  ...
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_tokens_recuperacion` (`token_hash`),
  KEY `fk_tokens_recuperacion_usuario` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `cedula_pasaporte` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `correo` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefono` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_nacimiento` date DEFAULT NULL,
  `sexo` enum('MASCULINO','FEMENINO','OTRO','NO_ESPECIFICA') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usuario` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_hash` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol` enum('ADMINISTRADOR','OPERADOR','ORGANIZADOR','PARTICIPANTE') COLLATE utf8mb4_unicode_ci NOT NULL,
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  ...
  UNIQUE KEY `uq_usuarios_cedula` (`cedula_pasaporte`),
...
(1, 'Administrador', 'Principal', NULL, 'admin.sistema@utp.edu.pa', '6000-0000', NULL, NULL, 'admin', '$2y$12$6lKmNFOwihDFfreCpg1s4uyIgso2udjEpkiujBXKXvHP/3k8/eEaS', 'ADMINISTRADOR', 1, 0, 0, NULL, '2026-07-13 17:42:38', NULL, '2026-07-13 15:09:13', '2026-07-13 17:42:38'),
...
--
DROP VIEW IF EXISTS `vw_actividades_publicas`;
CREATE TABLE IF NOT EXISTS `vw_actividades_publicas` (
...
,`edad_maxima` smallint unsigned
,`edad_minima` smallint unsigned
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vw_desempeno_arbitros`;
CREATE TABLE IF NOT EXISTS `vw_desempeno_arbitros` (
